...
# ON LINES 149 AND 180, CHANGE THE IP ADDRESS TO YOUR HOST MACHINE TO CONNECT TO OLLAMA SERVER
# ON LINE 148, MAKE SURE THE CORRECT OLLAMA MODEL IS SET
...
async def main():
    ...
    async with connect("ws://192.168.64.1:12691") as websocket:
        buffer = io.StringIO()
        try:
            while True:
                ...
                if prompt.lower() in ["quit", "exit"]:
                    break
                print(f"Prompt received from the Dashboard: {prompt}")
