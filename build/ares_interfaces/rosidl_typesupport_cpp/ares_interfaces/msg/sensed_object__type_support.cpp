...
static const _SensedObject_type_support_symbol_names_t _SensedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ares_interfaces, msg, SensedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ares_interfaces, msg, SensedObject)),
  }
};
...
{
  return &::ares_interfaces::msg::rosidl_typesupport_cpp::SensedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ares_interfaces, msg, SensedObject)() {
  return get_message_type_support_handle<ares_interfaces::msg::SensedObject>();
}
